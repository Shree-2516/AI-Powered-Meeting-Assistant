...
from app.schemas.meeting import MeetingResponse, SentimentResult
...
async def process_meeting(audio: UploadFile = File(...), db: AsyncSession = Depends(get_db)):
    ...
    try:
        ...
        return MeetingResponse(
            ...
            createdAt=db_record.created_at.isoformat() if 'db_record' in locals() and db_record.created_at else None
        )
